...
const defaultAgent = { id: "general", name: "General Agent", avatar: "🤖", hired: true };
...
const SearchEngine = () => {
  ...
  const [userAgents, setUserAgents] = useState<Array<{id: string, name: string, avatar: string, hired: boolean}>>([defaultAgent]);
    ...
    const fetchAgents = async () => {
      ...
      try {
        ...
        for (const hiredAgent of hiredAgentsData) {
          ...
          const template = templatesData.find(t => t.id === hiredAgent.template_id);
          if (template) {
      ...
      <div className="container mx-auto px-4 pt-32">
        ...
        {messages.length === 0 && (
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Who can I help you find?</h1>
            <p className="text-gray-600 text-lg max-w-xl mx-auto">Our AI filters through millions of profiles to surface genuinely relevant people.</p>
          </div>
        )}

        {/* Search Box */}
        <div className={`max-w-2xl mx-auto ${messages.length > 0 ? 'mb-8' : 'mb-16'}`}>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {messages.map((message) => (
                message.type === 'agent' && (
                  <div key={message.id} className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-600 mb-3">Senior Software Engineer at Tech Company</p>
                        ...
                        <div className="mt-4 flex justify-between items-center">
                          ...
                          <div className="flex space-x-2">
                            <Button variant="outline" size="sm" className="rounded-full border-gray-200">View Profile</Button>
                            <Button size="sm" className="rounded-full bg-blue-600 hover:bg-blue-700">Contact</Button>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              {isLoading && (
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                  <div className="flex items-center justify-center py-8">
                    ...
                    <span className="text-gray-600 font-medium">Searching for the perfect match...</span>
                  </div>
                </div>
              )}
            </div>
