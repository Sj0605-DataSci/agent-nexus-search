...
const Offerings = () => {
  return (
    <section className="bg-[#B2DC8A] items-center justify-center py-12 sm:py-16 md:py-20 lg:py-24" aria-labelledby="offerings-title">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 xl:px-0">
        <header className="mx-auto max-w-2xl text-center px-4">
          <h2 id="offerings-title" className="text-3xl font-medium tracking-tight text-[#0E3D15] sm:text-4xl md:text-5xl">
            ...
            {offeringsData.map((offering, index) => (
              ...
              >
                <div
                  ...
                  aria-hidden="true"
                >
                  <div className="bg-white p-3 sm:p-4 rounded-full shadow-sm" role="img" aria-label={offering.title}>{offering.icon}</div>
                </div>
                <div className="p-4 sm:p-5 md:p-6 text-center h-28 md:h-36 lg:h-32 bg-white">
                  <h3 id={`offering-title-${index}`} className="text-lg sm:text-xl font-bold text-[#0E3D15] mb-1 sm:mb-2">
                    {offering.title}
                  </h3>
