  ...
  const searchModes = [
    {
      ...
      aryaResponse: "Found her. Dr. Rahman just joined Goldman Sachs as Head of Digital Assets. Here's her verified contact info and recent LinkedIn activity.",
      features: ["Quick profile & contact info", "Comprehensive background reports", "Real-time verification"],
      icon: "🎯",
    ...
    },
    {
      ...
      aryaResponse: "I've identified 12 fintech investors from your email history in Singapore. Here are the top 5 with recent funding activity.",
      features: ["Natural language understanding", "Context-aware filtering", "Learns from feedback"],
      icon: "🧠",
    ...
    },
    {
      ...
      aryaResponse: "Scanning your networks... Found 47 healthtech professionals across your platforms. 8 are highly active this month.",
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="mb-6">
                  <div className={`inline-block p-3 rounded-2xl bg-gradient-to-r ${searchModes[activeMode].color} text-white text-3xl mb-4`}>
                  ...
                  <p className="text-lg text-gray-600 mb-4">
                    {searchModes[activeMode].subtitle}
                  </p>
                ...
                <div className="space-y-3">
                  {searchModes[activeMode].features.map((feature, index) => (
                    ...
                    >
                      <div className={`w-2 h-2 rounded-full bg-gradient-to-r ${searchModes[activeMode].color}`} />
              ...
              <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-gray-800 font-medium">
                        {searchModes[activeMode].example}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {/* Arya Response */}
                <div className={`bg-gradient-to-r ${searchModes[activeMode].color} rounded-2xl p-6 text-white`}>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-white/90">
                        {searchModes[activeMode].aryaResponse}
                      </p>
                    </div>
                  </div>
                </div>
