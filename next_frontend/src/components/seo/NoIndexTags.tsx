...
export default function NoIndexTags() {
  useEffect(() => {
    ...
    if (!isProduction()) {
      ...
      robotsMetaTag.setAttribute('content', 'noindex, nofollow, noarchive, nositelinkssearchbox, nosnippet');
      ...
      const llmCrawlers = ['GPTBot', 'ChatGPT-User', 'Google-Extended', 'CCBot', 'anthropic-ai', 'Claude-Web', 'Omgilibot', 'FacebookBot'];
