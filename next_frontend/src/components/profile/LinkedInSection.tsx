...
interface LinkedInSectionProps {
  linkedinUrl?: string;
  hasConnections: "synced" | "syncing" | "no_data";
  onEditClick: () => void;
...
export function LinkedInSection({
  ...
  return (
    <>
      ...
      <div
        id="linkedin-section"
        className="border p-6 rounded-lg bg-white border-gray-200 transition-all hover:shadow-md"
      >
              ...
              <div className="flex items-center gap-2">
                ...
                {hasConnections === "syncing" && (
                  <div className="flex items-center text-blue-600">
                    <div className="animate-spin h-4 w-4 mr-1 border-2 border-blue-600 border-t-transparent rounded-full" />
                    <span className="ml-1 text-sm">Syncing</span>
                  </div>
                )}
