...
const VideoPlayer = dynamic<VideoPlayerProps>(() => import("@/components/Homepage/VideoPlayer"), { ssr: false });
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed">
                Sharp, adaptive, and precise. No filters. No fluff. Just Arya, your personal tracker who's always two steps ahead.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="space-y-16">
              <div className="text-center">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Understands your query like I know the faces in Winterfell—no filters needed, just tell me what you need.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Query once, I remember—sharpens with your feedback and evolves with every search.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  From your inbox to the globe—no lead is safe from me. Global reach meets personal networks.
                </p>
              </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="text-center">
                <div className="w-16 h-16 bg-gray-900 text-white rounded-full flex items-center justify-center font-bold text-xl mb-4 mx-auto">1</div>
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-gray-900 text-white rounded-full flex items-center justify-center font-bold text-xl mb-4 mx-auto">2</div>
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-gray-900 text-white rounded-full flex items-center justify-center font-bold text-xl mb-4 mx-auto">3</div>
        ...
        <section className="py-20 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
              Join professionals who trust Arya's precision hunting to find the right people, fast.
            </p>
            <Link href="/user-auth">
