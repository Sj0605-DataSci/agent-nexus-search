          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-6">
                  Inspired by precision and loyalty, Arya remembers every search, learns from every
                  interaction, and gets better at finding exactly who you need.
                </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16">
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
                We're a team of builders and dreamers who believe that finding the right people
                should be as natural as having a conversation. We've worked across AI, search, and
                people analytics at different companies, and we're passionate about making human
                connections more meaningful and precise.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              <div className="text-center">
                ...
                <p className="text-gray-500 text-sm mb-4">
                  AI/ML + Backend Engineer with experience at YC-backed startups (Writesonic, Unify,
                  Buildspace), Nokia, EY, and Thena AI. Specializes in LLMs, RAG systems, and
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">Co-Founder</p>
                <p className="text-gray-500 text-sm mb-4">
                  Software Engineer & Researcher with expertise in full-stack development, QA
                  automation, and AI research. Published researcher with 3+ papers on AI and
            ...
            <div className="text-center bg-gray-50 rounded-2xl p-12">
              ...
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
                We envision a world where every professional interaction starts with the right
                connection. Where finding talent, partners, or opportunities is as simple as
